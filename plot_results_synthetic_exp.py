...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Plot results from the synthetic GMM experiment.")
    parser.add_argument(
        '--input_file', 
        type=str, 
        required=True, 
        help="Path to the .npz results file (e.g., simulation_results/results_n100.npz)."
    )
